            										...
            										<div class="row">
            											...
            											<div class="col-lg-6">
            												...
            												<div class="form-group">
            													...
            													<input type="text" name="pekerjaan_warga" class="form-control" value="<?= $data->pekerjaan_warga ?>">
            												</div>

            												<div class="form-group">
            													<label for="">Tempat Lahir</label>
            													<input type="text" name="tempat_lahir_warga" class="form-control" value="<?= $data->tempat_lahir_warga ?>">
            												</div>
