            <div class="main-content container-fluid">
            	<div class="page-title">
            		<h4>Verifikasi Surat Keterangan Pemakaman</h4>
            	</div>
            											...
            											<td>
            												<?php if ($this->session->userdata('role_id') == 1) { ?>
            													...
            													<?php } else if ($data->status == 'Diterima') { ?>
            														<div class="btn-group">
            															<a href="<?= base_url('cetak-surat-keterangan-pemakaman/' . $data->id . '?nomor=' . $data->nomor_surat) ?>" class="btn btn-primary btn-sm" target="blank_"><i class="bi bi-printer-fill"></i></a>
            														...
            														<div class="modal-dialog">
            															<div class="modal-content">
            																...
            																<div class="modal-footer">
            																	...
            																	<a href="<?= base_url('hapus-surat-keterangan-pemakaman/' . $data->id) ?>" class="btn btn-danger btn-sm">Hapus</a>
            																</div>
            															</div>
            														</div>
            													</div>
