			...
			<div class="card pt-2">
				<div class="card-body">
					<div class="text-center mb-2">
						<img src="<?= base_url() ?>./assets/logo/clp.png" height="100" class='mb-3'>
						<!-- <h3>Sign In</h3> -->
						<h5><strong>APLIKASI LAYANAN SURAT</strong></h5>
						<h6><strong>DESA KARANGKANDRI</strong></h6>
						<h7><strong>(DIDESKAR)</strong></h7>
