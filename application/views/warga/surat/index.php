...
<div class="main-content container-fluid">
    <div class="page-title">
        <h5><strong>Menu Surat</strong></h5>
    </div>
            ...
            <div class="col-lg-12">
                <div class="row m-3">
                    <div class="col-lg-12 overflow-auto">
                        ...
                        <a href="<?= base_url('skdu/buat-surat') ?>" class="mb-3">
                            <div class="unread custom-alert-3 bg-white" role="alert">
                                <div class="alert-text w-75 mt-2 p-4 d-flex flex-row">
                                    <img src="<?= base_url() ?>./assets/icons/envelope.png" class="img-icon">
                                    <h6 class="font-bold ml-3 my-auto">Surat Keterangan Domisili Usaha</h6>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="<?= base_url('skbn/buat-surat') ?>" class="mb-3">
                            <div class="unread custom-alert-3 bg-white" role="alert">
                                <div class="alert-text w-75 mt-2 p-4 d-flex flex-row">
                                    <img src="<?= base_url() ?>./assets/icons/envelope.png" class="img-icon">
                                    <h6 class="font-bold ml-3 my-auto">Surat Keterangan Beda Nama</h6>
                                </div>
                            </div>
                        <a href="<?= base_url('skp/buat-surat') ?>" class="mb-3">
                            <div class="unread custom-alert-3 bg-white" role="alert">
                                <div class="alert-text w-75 mt-2 p-4 d-flex flex-row">
                                    <img src="<?= base_url() ?>./assets/icons/envelope.png" class="img-icon">
                                    <h6 class="font-bold ml-3 my-auto">Surat Keterangan Pemakaman</h6>
                                </div>
                            </div>
                        </a>
                    </div>
