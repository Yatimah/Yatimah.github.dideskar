            <div class="main-content container-fluid">
            	<div class="page-title">
            		<h4>History Surat Keterangan Pemakaman</h4>
            	</div>
            										...
            										<tr>
            											...
            											<td>
            												<?php if ($data->status == 'Diterima') { ?>
            													<a href="<?= base_url('cetak-surat-keterangan-pemakaman/' . $data->id . '?nomor=' . $data->nomor_surat) ?>" class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-printer-fill"></i> Cetak</a>
