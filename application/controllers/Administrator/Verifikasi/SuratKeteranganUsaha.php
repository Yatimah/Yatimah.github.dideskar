<?php
class SuratKeteranganUsaha extends CI_Controller
{
	...
	{
		$data = array(
			'title' => 'Verifikasi Surat Keterangan Usaha',
			'datas'  => $this->M_verifikasi->getSku()
		);

		$this->load->view('layout/header', $data);
		$this->load->view('layout/sidebar', $data);
		$this->load->view('administrator/verifikasi/sku/surat_keterangan_usaha', $data);
	...
	public function skuverif()
	{
		...
		if ($status == 'Diterima') {
			...
			redirect('verifikasi-surat-keterangan-usaha', 'refresh');
	...
	{
		$data = array(
			'title' => 'Preview Surat Keterangan Usaha',
	...
	{
		$this->M_verifikasi->hSuratKeteranganUsaha($id);
